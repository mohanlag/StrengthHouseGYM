...
// Check if user is logged in and has the 'member' role
...
<head>
    ...
    <!-- =================== Scripts =================== -->
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script> <!-- For charts if needed -->
</head>
<body>
        ...
        <div class="main-content">
            ...
            <div class="nutrition-grid">
                ...
                <div class="nutrition-card">
                    ...
                    <!-- Button to view full meal plans -->
                ...
                <div class="nutrition-card">
                    <h3>Log Food</h3>
                    <!-- Form to add food intake -->
                <form class="food-form" method="POST" action="">
                    <input type="text" name="food_name" placeholder="Food item" class="form-control" required>
                    <input type="number" name="calories" placeholder="Calories" class="form-control" required>
                    <input type="number" name="protein" placeholder="Protein (g)" class="form-control" required>
                    <input type="number" name="carbs" placeholder="Carbs (g)" class="form-control" required>
                    <input type="number" name="fat" placeholder="Fat (g)" class="form-control" required>
                    <button type="submit" class="btn">Add Food</button>
            </form>

                </div>
            </div> <!-- End nutrition-grid -->
